...
# 변수는 객체의 첫 인데스에 해당하는 값 부터 마지막에 해당하는 값까지 차례대로 정의된다.

for x in 'abc':
    print(x)

for x in {'one','two','three'}: #set 구조이기 때문에 순차적으로 반환되지 않음
    print(x)
