...
# 장점
# 1. 고성능 = 아주 빠른 성능을 제공하며, 기존의 flask 같은 웹 프레임 워크보다 2배가량 빠르다.
# 2. 쉬운 사용 = 작성하기 쉬운 코드 방식을 가지고 있다.
# 3. 자동 문서화 = swagger 문서지원
# 4. 비동기 지원 = 비동기 기능을 지원하여 비동기 작업을 쉽게 처리 할 수 있다.
...
# 스크립트가 실행 될 때, __name__ 변수는 "__main__" 으로 설정된다.
# 스크립트가 다른 모듈에 임포트 될 때 __name__ 변수는 해당 모듈의 이름응로 바뀐다.
