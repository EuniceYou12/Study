...
# async def edit(request: Request, task: str = Form(...), db: Session = Depends(get_db)):
#   completed = models.Todo(task=task)
  
#   return templates.TemplateResponse("edit.html", {"request":request, "completed":completed})

# @app.delete("/delete/{todo.id}")
# async def delete(request: Request, task: str = Form(...)):
#   return