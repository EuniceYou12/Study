...
print(address[5:8]) # 5번부터 8번 인덱스 까지
print(address[1:12:4]) # 1번부터 12번 인덱스 까지 4개씩 건너뛰면서 출력
print(address[::-1]) # 문자열 뒤집기
print(address[-3:]) # 뒤에서부터 시작 접근 가능

# 문자열 * 연산
subject = 'python'
print(subject * 3) # 해당문자열이 3번 반복
